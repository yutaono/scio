...
private[nn] class MatrixNNBuilder[K: ClassTag, @specialized(Double, Int, Float, Long) V: ClassTag : Numeric : Semiring]
...
private[nn] class LSHNNBuilder[K: ClassTag, @specialized(Double, Int, Float, Long) V: ClassTag : Numeric : Semiring]
